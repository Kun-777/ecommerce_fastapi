                ...
                <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
                    ...
                    <td align="center" bgcolor="#f2f2f2" style="padding: 40px 0;">
                        ...
                        <tr>
                            ...
                            <a href="http://{settings.client_hostname}/verify_email" target="_blank" style="font-size: 16px; font-weight: bold; color: #ffffff; text-decoration: none; padding: 12px 30px; border-radius: 5px; display: inline-block;">Verify Email</a>
                            </td>
                        </tr>
                        </table>
                    </td>
